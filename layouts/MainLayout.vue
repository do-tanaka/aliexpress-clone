    ...
    <div id="TopMenu" class="w-full bg-[#FAFAFA] border-b md:block hidden">
      ...
      >
        ...
        <li
          ...
          :class="
            isAccountMenu
              ? 'bg-white border z-40 shadow-[0_15px_100px_40px_rgba(0,0,0,3)]'
              : 'border border-[#FAFAFA]'
          "
        >
          <Icon name="ph:user-thin" size="17" />
          Account
          <Icon name="zondicons:cheveron-down" size="15" class="ml-5" />
          <div
            id="AccountMenu"
          ...
          >
            <div v-if="isAccountMenu">
              ...
              <div class="flex items-center gap-1 px-3 mb-3">
                <NuxtLink
                  to="/auth"
                  class="bg-[#FF4646] text-center w-full text-[16px] text-white font-semibold p-2 rounded-sm"
                >
                  Login / Register
                </NuxtLink>
              </div>
    ...
    <div id="MainHeader" class="flex items-center w-full bg-white">
      ...
      >
        ...
        <NuxtLink to="/shoppingcart" class="flex items-center">
          ...
          >
            <span
              class="absolute flex items-center justify-center min-w-[17px] -right-[3px] top-0 bg-[#FF4646] h-[17px] text-xs text-white px-0.5 rounded-full"
            >
              0
            </span>
...
let searchItem = ref<string | null>('')
</script>
